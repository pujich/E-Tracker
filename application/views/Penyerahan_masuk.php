  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        <?php $role=$this->session->userdata('role'); if($role=='repair'){ ?>
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Status AP per witel">
         ...
         <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Buat berita acara">
          <a class="nav-link" href="<?php echo base_url("Make_ba");?>">
    ...
    <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Histori">
      ...
      <li class="nav-item" data-toggle="tooltip" data-placement="right" title="AP yang belum diproses">
          ...
          <ul class="sidenav-second-level collapse" id="collapseNotYet">
            ...
            <li>
              <a href="<?php echo base_url("Make_ba/penyerahan_masuk");?>">Repair</a>
            </li>
          </ul>
      </ul>
        </li>
         ...
         <div class="table-responsive" style="overflow:auto;">
              ...
              foreach ($data as $x) {  ?>
                ...
                <tr>
                  ...
                  <TD>
                    <?php if($role=='witel' && $x['PENERIMA']==NULL){ ?>

                    <a href="<?php echo base_url('Make_ba/validate?id_ba='.$x['ID_BA']); ?>"><button class="btn btn-success">Setujui</button></a>  

                    <?php  if ($x['PENERIMA']==NULL) {
                      # code...
                    ?>
                    <a href="<?php echo base_url('Ba/view_ba_unfinished?id_ba='.$x['ID_BA']); ?>"><button class="btn btn-primary">Buat</button></a></TD>

                    <?php }} else { ?>
                    
                    <a href="<?php echo base_url('Ba/view_ba_penyerahan?id_ba='.$x['ID_BA']); ?>"><button class="btn btn-primary">Buat</button></a></TD>
                    <?php } ?>
                </tr>
