...
<style type="text/css"> * {margin:0; padding:0; text-indent:0; }
 ...
 .s2 { color: black; font-family:Tahoma, sans-serif; font-style: normal; font-weight: normal; text-decoration: none; font-size: 9.5pt; }
	...
	foreach ($user as $key) {	
		...
		$html .= '
		<p style="padding-left: 67pt;text-indent: 0pt;text-align: left;">Pada hari ini, '.$date.', kami yang bertanda tangan di bawah ini :</p>
	<h2 style="padding-top: 2pt;padding-left: 69pt;text-indent: 0pt;text-align: left;">Dari :</h2>
	...
	<h2 style="padding-top: 3pt;padding-left: 69pt;text-indent: 0pt;text-align: left;">Kepada :</h2>
	<p style="padding-top: 3pt;padding-left: 69pt;text-indent: 0pt;text-align: left;">NIK <b>: </b>'.$key['NIK_PENERIMA'].'</p>
	<p style="padding-top: 3pt;padding-left: 69pt;text-indent: 0pt;text-align: left;">NAMA <b>: </b>'.$key['NAMA_PENERIMA'].'</p>
	<p style="padding-top: 3pt;padding-left: 69pt;text-indent: 0pt;text-align: left;">WITEL <b>: </b>'.$key['WITEL_PENERIMA'].'</p>';
}
	$html .= '
...
foreach ($user as $x) {
	...
	<tr>
	<td></td><td align="center">'.$x['WITEL_PENGIRIM'].', '.$date2.'</td></tr></table>	
		 <table style="font-size: 8.5;"><tr><td align="center" >'.$x['JABATAN_PENERIMA'].'</td>
		 ...
		 <tr>
		 <td align="center">'.$x['NAMA_PENERIMA'].'</td> 
		 <td align="center">'.$x['NAMA_PENGIRIM'].'</td>
		 </tr></table>

		 <table style="font-size: 8.5;">
		 <tr>
		 <td align="center">NIK : '.$x['NIK_PENERIMA'].'</td>
		 <td align="center">NIK : '.$x['NIK_PENGIRIM'].'</td>
		 </tr> </table>
		 <p style="padding-top: 3pt;padding-left: 221pt;text-indent: 0pt;line-height: 132%;text-align: center;">Mengetahui, <br>	MANAJER WITEL</p>
		 <p><br/></p>
		 <p><br/></p>
		 <p><br/></p>
		 <p style="padding-top: 7pt;padding-left: 208pt;text-indent: 0pt;line-height: 131%;text-align: center;">(<u>.................................</u>) <br>NIK : ................</p></body></html>';
}
